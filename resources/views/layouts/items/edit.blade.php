    ...
    <div class="col-md-4 col-sm-6 m-t-25">
        <form method="POST" action="/items/{{$item->id}}/edit" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="text"  class="form-control" id="name" name="item_name"  value="{{$item->item_name}}" >
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class='input-group date' id='releaseDate'>
                    <input type='text' class="form-control" name="release_date" data-date-format="YYYY-MM-DD"  value="{{$item->release_date}}" />
